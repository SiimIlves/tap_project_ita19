            ...
            <div class="card-body">
                <form class="form" role="form" method="post" action="<?php echo URLROOT . '/users/register' ?>">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php echo (!emtpy($data['name_err'])) ? 'is_invalid' : '';?>" id="name" name="name" placeholder="Full name" value="<?php echo $data['name'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control <?php echo (!emtpy($data['password_err'])) ? 'is_invalid' : '';?>" id="password" name="password"
                               placeholder="Password" value="<?php echo $data['password'];?>">
                        <span class="invalid-feedback"><?php echo $data['password_err'];?></span>
                    </div>
                    <div class="form-group">
                        <label for="confirm_password">Password<sup>*</sup></label>
                        <input type="password" class="form-control <?php echo (!emtpy($data['confirm_password_err'])) ? 'is_invalid' : '';?>" id="confirm_password" name="confirm_password"
